...
import com.mymatatu.App_Importants.SeatingQuery;
...
public class SeatingArrangment2 extends Fragment implements View.OnClickListener {

    private TextView seat_info;
    Button cancel, done;
    String print = "";
    String s_id, matatu_name, sacco_name, price,m_id,sapc_id;
...
//    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.seating_model2, container, false);
        ...
        sq = new SeatingQuery(getActivity(),9,m_id);
        //i =sq.sendseatingrequest();
...
//                    mButton2.setText(R.string.button2);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.seat8:
                if (!tb[7].isChecked()) {
                    tb[7].setBackgroundResource(R.drawable.seat_layout_screen_nor_std);
                    ...
                    tb[7].setBackgroundResource(R.drawable.seat_layout_screen_nor_avl);
            ...
            case R.id.seat9:
                if (!tb[8].isChecked()) {
                    tb[8].setBackgroundResource(R.drawable.seat_layout_screen_nor_std);
                    ...
                    tb[8].setBackgroundResource(R.drawable.seat_layout_screen_nor_avl);
    ...
    public void change() {
        ...
        bundle.putString("matatu_id", m_id);
        bundle.putString("sapc_id", sapc_id);
